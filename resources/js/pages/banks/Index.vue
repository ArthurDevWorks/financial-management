...
import { Building2, Download, Landmark, Plus } from 'lucide-vue-next';
            ...
            >
                ...
                <template #head>
                    <tr class="border-b border-border">
                        <th
                            class="w-20 px-4 py-3 text-left text-xs font-semibold tracking-wider text-muted-foreground uppercase"
                        >
                            Logo
                        </th>
                        <th
