...
const form = useForm({
  account_id: props.revenue.account_id,
  category_id: props.revenue.category_id,
  name: props.revenue.name,
  value: props.revenue.value,
  dt_revenue: props.revenue.dt_revenue,
  description: props.revenue.description,
})

const submit = () => {
  form.put(`/revenues/${props.revenue.id}`)
}
