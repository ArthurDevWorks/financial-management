...
import { Bar as ChartBar, Radar as ChartRadar } from 'vue-chartjs';
...
function isBest(value: number | null | undefined, indicator: string): boolean {
    ...
    const higherIsBetter = ['dividend_yield', 'roe', 'profit_margin'].includes(
        indicator,
    );
    ...
    <AppLayout>
        <div class="p-6 lg:p-8">
            <PageHeader
                ...
                description="Análise lado a lado de indicadores fundamentalistas"
            >
                <template #actions>
                    <Button
                        variant="outline"
                        size="sm"
                        @click="router.visit('/screening')"
                    >
            ...
            <div class="mb-6 flex flex-wrap gap-3">
                ...
                >
                    <div
                        class="flex h-10 w-10 items-center justify-center rounded-lg border border-border bg-surface font-bold text-primary"
                    >
                        {{ a.ticker.charAt(0) }}
                    </div>
                    <div class="flex-1">
                ...
                <button
                    class="flex flex-1 items-center justify-center gap-2 rounded-lg border border-dashed border-border p-4 text-sm text-muted-foreground transition-all hover:border-primary hover:bg-primary/5 hover:text-primary"
                >
                    <Plus class="h-4 w-4" />
                    Adicionar ativo
                </button>
            ...
            <!-- Comparison Table -->
            <div
                class="mb-6 overflow-hidden rounded-xl border border-border bg-card"
            >
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="border-b border-border bg-black/10">
                                <th
                                    class="w-44 px-4 py-3 text-left text-[11px] font-semibold tracking-wider text-muted-foreground uppercase"
                                >
                                    Indicador
                                </th>
                                <th
                                    v-for="a in assetList"
                                    :key="a.ticker"
                                    class="px-4 py-3 text-center text-[11px] font-semibold tracking-wider text-muted-foreground uppercase"
                                >
                                    {{ a.ticker }}
                                </th>
                            </tr>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-border bg-black/5">
                                <td
                                    ...
                                    class="px-4 py-2 text-[10px] font-semibold tracking-wider text-muted-foreground uppercase"
                                >
                                    Preço & Mercado
                                </td>
                            </tr>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span
                                        ...
                                        "
                                        class="ml-1 rounded-full bg-revenue/10 px-1.5 py-0.5 text-[9px] font-bold text-revenue uppercase"
                                        >✔</span
                                    >
                                </td>
                            </tr>
                            ...
                            >
                                ...
                                <td
                                    ...
                                    class="px-4 py-3 text-center font-mono text-sm"
                                    :class="
                                        isBest(a.price_to_book, 'price_to_book')
                                            ? 'text-revenue'
                                            : ''
                                    "
                                >
                            ...
                            >
                                ...
                                <td
                                    ...
                                    class="px-4 py-3 text-center font-mono text-sm"
                                    :class="
                                        isBest(a.ev_to_ebitda, 'ev_to_ebitda')
                                            ? 'text-revenue'
                                            : ''
                                    "
                                >
                            ...
                            >
                                ...
                                <td
                                    ...
                                    class="px-4 py-3 text-center font-mono text-sm"
                                    :class="
                                        isBest(a.profit_margin, 'profit_margin')
                                            ? 'text-revenue'
                                            : ''
                                    "
                                >
                            ...
                            >
                                ...
                                <td
                                    ...
                                    class="px-4 py-3 text-center font-mono text-sm"
                                >
                                    {{ formatPercent(a.vacancy_financial) }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <div class="rounded-xl border border-border bg-card p-5">
                    <h3 class="mb-3 text-sm font-semibold">
                        Comparativo <span class="text-primary">Radar</span>
                    </h3>
                    <div class="h-[280px]">
                        <ChartRadar
                            :data="radarChartData"
                ...
                <div class="rounded-xl border border-border bg-card p-5">
                    <h3 class="mb-3 text-sm font-semibold">
                        Indicadores
                        <span class="text-primary">Lado a Lado</span>
                    </h3>
                    <div class="h-[280px]">
                        <ChartBar
                            :data="barChartData"
