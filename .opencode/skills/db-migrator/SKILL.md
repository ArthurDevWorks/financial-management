...
Inspect the current schema using docker exec from PROJECT_CONTEXT.md → Comandos de Dev → DB Access.
...
Run the following commands (substituting values from PROJECT_CONTEXT.md → Comandos de Dev → DB Access):
...
- Uses: docker exec psql (commands from PROJECT_CONTEXT.md → Comandos de Dev → DB Access)
