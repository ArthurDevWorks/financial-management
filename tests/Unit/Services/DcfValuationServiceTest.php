...
it('calcula valuation e preenche taxas de crescimento em falta', function () {
    ...
    expect($resultado['projected_cash_flows'])->toHaveCount(4);
    expect($resultado['projected_cash_flows'][0]['projected_fcf'])->toBe(100.0);
    expect($resultado['projected_cash_flows'][1]['projected_fcf'])->toBe(110.0);
